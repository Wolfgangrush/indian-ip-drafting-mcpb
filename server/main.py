"""wolfgang_rush — Indian IP Drafting MCPB.

Local-execution.

License: MIT
Source: https://github.com/Wolfgangrush/indian-ip-drafting-mcpb
...
mcp = FastMCP("wolfgang-indian-ip-drafting")

BUNDLE_ROOT = Path(__file__).resolve().parent.parent
SKILLS_DIR = BUNDLE_ROOT / "skills"
AGENTS_DIR = BUNDLE_ROOT / "agents"
PLEADING_BASE_DIR = SKILLS_DIR / "_ip_drafting_base"

CASE_TYPES: list[str] = [
    "trademark-infringement-suit",
    "trademark-rectification-application",
    "copyright-infringement-suit",
    "copyright-fair-dealing-defence",
    "patent-infringement-suit",
    "patent-revocation-application",
    "design-piracy-suit",
    "passing-off-suit",
    "john-doe-anton-piller-order-application",
    "interim-injunction-application-ip",
]
...
FULL_ORCHESTRATION_SCRIPT = """# wolfgang_rush — INDIAN IP FORUMS (TRADEMARK REGISTRY / PATENT OFFICE / IP DIVISION OF HCS) DRAFTING · FULL ORCHESTRATION SCRIPT
...
trademark-infringement-suit, trademark-rectification-application, copyright-infringement-suit, copyright-fair-dealing-defence, patent-infringement-suit, patent-revocation-application, design-piracy-suit, passing-off-suit, john-doe-anton-piller-order-application, interim-injunction-application-ip.
...
def get_pleading_base() -> str:
    """Get the shared ip drafting base structure."""
