"""Wolfgang Rush — Indian IP Drafting MCPB.
...
FULL_ORCHESTRATION_SCRIPT = """# WOLFGANG RUSH — INDIAN IP FORUMS (TRADEMARK REGISTRY / PATENT OFFICE / IP DIVISION OF HCS) DRAFTING · FULL ORCHESTRATION SCRIPT
